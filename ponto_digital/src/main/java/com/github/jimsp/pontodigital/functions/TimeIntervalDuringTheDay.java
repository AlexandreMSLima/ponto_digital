...
public final class TimeIntervalDuringTheDay implements BiFunction<Employer, Predicate<Date>, Integer> {
	...
	private final BinaryOperator<Long> interval = Context.interval();
	...
	private final BiFunction<Employer, Predicate<Date>, Integer> timeWorkedDuringTheDay = Context.timeIntervalDuringTheDay();
	private final BiFunction<List<String>, Predicate<Date>, Date> firstEntrieDay = Context.firstEntrieDay();
	private final BiFunction<List<String>, Predicate<Date>, Date> lastEntrieDay = Context.lastEntries();
